...
1. #32 Drum step subdivisions -> `docs/features/13-drum-step-subdivisions.md`
2. #34 Arrangement mixer panel UI shell -> `docs/features/14-arrangement-mixer-panel-ui-shell.md`
